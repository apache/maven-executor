...
/**
 * The Interpolator provides methods for variable substitution in strings and maps.
...
public interface Interpolator {
     ...
     */
    default void interpolate(Map<String, String> properties, UnaryOperator<String> callback) {
     ...
     */
    default void interpolate(Map<String, String> map, UnaryOperator<String> callback, boolean defaultsToEmpty) {
     ...
     */
    default String interpolate(String val, UnaryOperator<String> callback) {
     ...
     * @return The interpolated string, or null if the input was null.
     */
    default String interpolate(String val, UnaryOperator<String> callback, boolean defaultsToEmpty) {
