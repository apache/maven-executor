...
public interface Tool {
     ...
     */
    Map<String, String> dump() throws ExecutorException;

    /**
     * Returns the used/test Maven version.
     */
    String mavenVersion();
     ...
     */
    String localRepository() throws ExecutorException;

    /**
     * Returns relative (to {@link #localRepository()}) path of given artifact in local repository.
     *
     * @param gav the usual resolver artifact GAV string, never {@code null}
     * @param repositoryId the remote repository ID in case "remote artifact" is asked for, or {@code null}.
     */
    String artifactPath(String gav, String repositoryId) throws ExecutorException;

    /**
     * Returns relative (to {@link #localRepository()}) path of given metadata in local repository.
     ...
     * @param repositoryId the remote repository ID in case "remote metadata" is asked for, or {@code null}.
     */
    String metadataPath(String gav, String repositoryId) throws ExecutorException;
}
