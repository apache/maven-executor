...
class DefaultInterpolatorTest {
    ...
    void testSubstLoop() {
        assertThrows(
                ...
                () -> substVars("${a}", "a"),
                "Expected substVars() to throw an IllegalArgumentException, but it didn't");
    }
    ...
    private void performSubstitution(Map<String, String> props, UnaryOperator<String> callback) {
        DefaultInterpolator.defaultMavenInterpolator().performSubstitution(props, callback);
    }
    ...
    private String substVars(
        ...
        return DefaultInterpolator.defaultMavenInterpolator()
    ...
    private String substVars(String val, String currentKey) {
        return DefaultInterpolator.defaultMavenInterpolator().substVars(val, currentKey, null, null, null, null, true);
    }

    private String substVars(String val, String currentKey, Map<String, String> configProps) {
        return DefaultInterpolator.defaultMavenInterpolator().substVars(val, currentKey, null, configProps);
    }
}
